...
public class DetallePeriodosReservadosActualizarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_periodos_reservados_actualizar);
        ...
        EditFechaDetalle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(DetallePeriodosReservadosActualizarActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
